...
<div class="card">
    ...
    <div class="card-body">
        <form action="/data-user" method="post" id="createuser-form">
            @csrf 
            {{-- @method('PUT') --}}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" placeholder="Masukkan Nomor Hp" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" required value="{{ old('no_hp') }}">
                    @error('no_hp')
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    @error('password')
                    <div class="invalid-feedback">
                        Password harus terdiri lebih dari 5 karakter
                    </div>
                    @enderror
                </div>
