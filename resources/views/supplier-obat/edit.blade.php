        ...
        <div class="container" id="container">
            <div class="row" id="fieldsupplier">
                ...
                <div class="form-group col">
                    ...
                    <input type="number" placeholder="Masukkan No Telp" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" required value="{{ old('no_hp',$supplier_obat->no_hp) }}">
                    @error('no_hp')
                    <div class="invalid-feedback">
                        {{ $message}}
                    </div>
